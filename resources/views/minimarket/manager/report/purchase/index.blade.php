                                    ...
                                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase">Number of Items Purchased</th>
                                        ...
                                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">{{ $initialStock }}</td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">{{ $report->totalStock }}</td>
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200"></td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">Total Transaksi : {{ $totalTransactions }}</td>
                                                <td colspan="1" class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">Initial Stock : {{ $initialStock }}</td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">Total Items : {{ $dailyReports->sum('totalStock') + $initialStock }}</td>
