        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <x-primary-button tag="a" href="{{route('minimarket.manager.discount.create')}}">New Discount Event</x-primary-button>
                    <br>
                                ...
                                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                  ...
                                  <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">
                                        <x-primary-button tag="a" href="{{ route('minimarket.manager.discount.edit', ['id' => $diskon->id]) }}"> Edit </x-primary-button>
                                        <x-danger-button
                                            x-data=""
                                            x-on:click.prevent="$dispatch('open-modal', 'confirm-user-deletion')"
                                            x-on:click="$dispatch('set-action', '{{ route('minimarket.manager.discount.destroy', $diskon->id) }}')"
